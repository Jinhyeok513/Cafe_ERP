"""Generate clean purchase, receipt, movement and stocktake history."""
    ...
    for day in days:
        for pending in pending_receipts.pop(day, []):
            ...
            for item in pending["items"]:
                ...
                accepted_inventory_quantity = order_quantity * decimal_value(product["pack_size"])
                ...
                goods_receipt_items.append(
                    {
                        ...
                        "accepted_quantity": item["ordered_quantity"],
            ...
            stocktake_items.append(
                {
                    ...
                    "physical_quantity": format_quantity(current_quantity),
                    "system_quantity": format_quantity(current_quantity),
                    "variance": format_quantity(Decimal(0)),
                    "review_status": "MATCH",
                }
            )
